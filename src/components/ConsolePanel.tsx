      ...
      {tab === 'console' ? (
            ...
            {!inputSupported ? (
              ...
              <>
                ...
                <button
                  type="button"
                  onClick={onEndInput}
                  title="Signal end of input (Ctrl+D) — Console.ReadLine() then returns null"
              ...
              <p className="text-xs text-slate-500">
                Typed input appears here when the program calls <code>Console.ReadLine()</code>.
        ...
        <div className="flex min-h-0 flex-1 flex-col gap-1 bg-slate-950/60 p-2">
          <p className="text-xs text-slate-400">
            One line per <code>Console.ReadLine()</code>. These are consumed from the top on every run,
                ...
                <li key={`${diagnostic.id}-${index}`}>
                  ...
                  >
                    ...
                    <span className="min-w-0 flex-1">
                      <span className="text-slate-200">{diagnostic.message}</span>
