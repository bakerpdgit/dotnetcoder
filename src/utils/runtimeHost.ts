/**
 * Owns the .NET runtime worker as a *page-level* resource.
 *
 * Booting the runtime costs a multi-megabyte download and several seconds, so
 ...
 * mid-download and created again. That wasted the whole bundle download twice
 * and, worse, made the main-thread runtime call dotnet.create() twice, which
 * fails outright with "Runtime module already loaded".
 *
